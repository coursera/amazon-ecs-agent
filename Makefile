...
release: certs docker-release
	...
	@docker build -f scripts/dockerfiles/Dockerfile.release -t "DOCKER_REGISTRY_SERVER:5000/amazon-ecs-agent-cleaner:make" .
	@echo "Built Docker image \"DOCKER_REGISTRY_SERVER:5000/amazon-ecs-agent-cleaner:make\""
